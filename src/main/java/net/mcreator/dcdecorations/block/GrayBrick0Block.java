...
public class GrayBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:gray_brick_0")
	public static final Block block = null;
	public GrayBrick0Block(DcdecorationsModElements instance) {
		super(instance, 33);
	}
