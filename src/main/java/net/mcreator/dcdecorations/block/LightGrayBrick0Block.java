...
public class LightGrayBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:light_gray_brick_0")
	public static final Block block = null;
	public LightGrayBrick0Block(DcdecorationsModElements instance) {
		super(instance, 29);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_gray_brick_0");
		}
