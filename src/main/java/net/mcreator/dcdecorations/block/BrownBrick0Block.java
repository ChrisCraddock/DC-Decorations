...
public class BrownBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:brown_brick_0")
	public static final Block block = null;
	public BrownBrick0Block(DcdecorationsModElements instance) {
		super(instance, 17);
	}
