...
public class LightBlueBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:light_blue_brick_1")
	public static final Block block = null;
	public LightBlueBrick1Block(DcdecorationsModElements instance) {
		super(instance, 51);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_blue_brick_1");
		}
