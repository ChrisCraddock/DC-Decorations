...
public class PDUScreenBlock extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:pdu_screen")
	public static final Block block = null;
	public PDUScreenBlock(DcdecorationsModElements instance) {
		super(instance, 184);
	}
