...
public class RedBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:red_brick_0")
	public static final Block block = null;
	public RedBrick0Block(DcdecorationsModElements instance) {
		super(instance, 9);
	}
