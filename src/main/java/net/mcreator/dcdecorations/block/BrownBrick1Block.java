...
public class BrownBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:brown_brick_1")
	public static final Block block = null;
	public BrownBrick1Block(DcdecorationsModElements instance) {
		super(instance, 18);
	}
