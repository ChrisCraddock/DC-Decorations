...
public class BlueBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:blue_brick_0")
	public static final Block block = null;
	public BlueBrick0Block(DcdecorationsModElements instance) {
		super(instance, 1);
	}
