...
public class LightGreenBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:light_green_brick_1")
	public static final Block block = null;
	public LightGreenBrick1Block(DcdecorationsModElements instance) {
		super(instance, 43);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_green_brick_1");
		}
