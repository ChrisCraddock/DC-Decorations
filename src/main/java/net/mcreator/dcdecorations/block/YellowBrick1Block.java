...
public class YellowBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:yellow_brick_1")
	public static final Block block = null;
	public YellowBrick1Block(DcdecorationsModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("yellow_brick_1");
		}
