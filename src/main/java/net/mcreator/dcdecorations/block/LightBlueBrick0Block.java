...
public class LightBlueBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:light_blue_brick_0")
	public static final Block block = null;
	public LightBlueBrick0Block(DcdecorationsModElements instance) {
		super(instance, 50);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_blue_brick_0");
		}
