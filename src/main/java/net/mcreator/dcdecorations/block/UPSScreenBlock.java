...
public class UPSScreenBlock extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:ups_screen")
	public static final Block block = null;
	public UPSScreenBlock(DcdecorationsModElements instance) {
		super(instance, 178);
	}
