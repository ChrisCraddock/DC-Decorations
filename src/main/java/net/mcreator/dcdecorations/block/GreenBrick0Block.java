...
public class GreenBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:green_brick_0")
	public static final Block block = null;
	public GreenBrick0Block(DcdecorationsModElements instance) {
		super(instance, 13);
	}
