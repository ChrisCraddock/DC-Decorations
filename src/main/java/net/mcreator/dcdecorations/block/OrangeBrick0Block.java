...
public class OrangeBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:orange_brick_0")
	public static final Block block = null;
	public OrangeBrick0Block(DcdecorationsModElements instance) {
		super(instance, 58);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_brick_0");
		}
