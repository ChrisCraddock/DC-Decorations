...
public class PinkBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:pink_brick_1")
	public static final Block block = null;
	public PinkBrick1Block(DcdecorationsModElements instance) {
		super(instance, 38);
	}
