...
public class Server2BottomBlock extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:server_2_bottom")
	public static final Block block = null;
	public Server2BottomBlock(DcdecorationsModElements instance) {
		super(instance, 193);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("server_2_bottom");
		}
