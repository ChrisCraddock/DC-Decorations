...
public class CyanBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:cyan_brick_1")
	public static final Block block = null;
	public CyanBrick1Block(DcdecorationsModElements instance) {
		super(instance, 26);
	}
