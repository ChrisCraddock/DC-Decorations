...
public class BlackBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:black_brick_0")
	public static final Block block = null;
	public BlackBrick0Block(DcdecorationsModElements instance) {
		super(instance, 5);
	}
