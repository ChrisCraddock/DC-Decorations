...
public class MagentaBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:magenta_brick_0")
	public static final Block block = null;
	public MagentaBrick0Block(DcdecorationsModElements instance) {
		super(instance, 54);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("magenta_brick_0");
		}
