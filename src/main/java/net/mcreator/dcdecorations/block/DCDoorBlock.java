...
public class DCDoorBlock extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:dc_door")
	public static final Block block = null;
	public DCDoorBlock(DcdecorationsModElements instance) {
		super(instance, 196);
	}
