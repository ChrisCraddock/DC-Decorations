...
public class LightGrayBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:light_gray_brick_1")
	public static final Block block = null;
	public LightGrayBrick1Block(DcdecorationsModElements instance) {
		super(instance, 30);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("light_gray_brick_1");
		}
