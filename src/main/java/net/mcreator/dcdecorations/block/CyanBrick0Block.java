...
public class CyanBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:cyan_brick_0")
	public static final Block block = null;
	public CyanBrick0Block(DcdecorationsModElements instance) {
		super(instance, 25);
	}
