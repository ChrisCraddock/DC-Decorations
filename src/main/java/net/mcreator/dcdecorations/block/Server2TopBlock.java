...
public class Server2TopBlock extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:server_2_top")
	public static final Block block = null;
	public Server2TopBlock(DcdecorationsModElements instance) {
		super(instance, 192);
	}
