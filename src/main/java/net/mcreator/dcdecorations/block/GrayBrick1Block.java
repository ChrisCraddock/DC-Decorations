...
public class GrayBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:gray_brick_1")
	public static final Block block = null;
	public GrayBrick1Block(DcdecorationsModElements instance) {
		super(instance, 34);
	}
