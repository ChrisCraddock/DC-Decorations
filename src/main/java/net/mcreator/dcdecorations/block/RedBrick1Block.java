...
public class RedBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:red_brick_1")
	public static final Block block = null;
	public RedBrick1Block(DcdecorationsModElements instance) {
		super(instance, 10);
	}
