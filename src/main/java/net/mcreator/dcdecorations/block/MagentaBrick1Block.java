...
public class MagentaBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:magenta_brick_1")
	public static final Block block = null;
	public MagentaBrick1Block(DcdecorationsModElements instance) {
		super(instance, 55);
	}
