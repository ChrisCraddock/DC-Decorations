...
public class WhiteBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:white_brick_1")
	public static final Block block = null;
	public WhiteBrick1Block(DcdecorationsModElements instance) {
		super(instance, 63);
	}
