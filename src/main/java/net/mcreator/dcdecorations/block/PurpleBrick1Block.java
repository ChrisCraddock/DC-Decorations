...
public class PurpleBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:purple_brick_1")
	public static final Block block = null;
	public PurpleBrick1Block(DcdecorationsModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purple_brick_1");
		}
