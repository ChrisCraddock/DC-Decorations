...
public class BlackBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:black_brick_1")
	public static final Block block = null;
	public BlackBrick1Block(DcdecorationsModElements instance) {
		super(instance, 6);
	}
