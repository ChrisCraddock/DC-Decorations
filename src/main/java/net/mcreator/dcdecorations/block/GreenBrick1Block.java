...
public class GreenBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:green_brick_1")
	public static final Block block = null;
	public GreenBrick1Block(DcdecorationsModElements instance) {
		super(instance, 14);
	}
