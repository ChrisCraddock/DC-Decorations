...
public class PinkBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:pink_brick_0")
	public static final Block block = null;
	public PinkBrick0Block(DcdecorationsModElements instance) {
		super(instance, 37);
	}
