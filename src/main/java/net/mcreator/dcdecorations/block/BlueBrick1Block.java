...
public class BlueBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:blue_brick_1")
	public static final Block block = null;
	public BlueBrick1Block(DcdecorationsModElements instance) {
		super(instance, 2);
	}
