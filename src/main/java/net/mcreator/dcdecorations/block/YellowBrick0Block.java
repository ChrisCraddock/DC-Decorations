...
public class YellowBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:yellow_brick_0")
	public static final Block block = null;
	public YellowBrick0Block(DcdecorationsModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("yellow_brick_0");
		}
