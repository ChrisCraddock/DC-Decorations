...
public class WhiteBrick0Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:white_brick_0")
	public static final Block block = null;
	public WhiteBrick0Block(DcdecorationsModElements instance) {
		super(instance, 62);
	}
