...
public class OrangeBrick1Block extends DcdecorationsModElements.ModElement {
	@ObjectHolder("dcdecorations:orange_brick_1")
	public static final Block block = null;
	public OrangeBrick1Block(DcdecorationsModElements instance) {
		super(instance, 59);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_brick_1");
		}
